 ...
 */
/***************************************************************************** *
 * $Id: dmpDefault.c 5018 2011-03-17 02:00:49Z nroyer $ 
 ******************************************************************************/
...
tMLError dmpDefault(void)
{
    ...
    ERROR_CHECK(result);
    result = MLDLSetGyroPower(TRUE, TRUE, TRUE);
    ERROR_CHECK(result);
    result = MLDLSetFullScaleMPU(2000.f);
    ERROR_CHECK(result);
    result = MLDLLoadDMP(dmpMemory, SCD, sConfig);
    ERROR_CHECK(result);
    result = MLDLSetIgnoreSystemSuspend(FALSE);
    ERROR_CHECK(result);

    {
        ...
        odr = 0;
        mpu3050_config_accel(MLDLGetCfg(), MLSerialGetHandle(),
                             &config);
