EXEC = pedometerstandalone$(SHARED_APP_SUFFIX)
...
CFLAGS += -Wall
#CFLAGS += -g
CFLAGS += -fpic -D_REENTRANT -DLINUX -DANDROID
CFLAGS += -DSK_RELEASE
...
CFLAGS += -I$(MLPLATFORM_DIR)/include -I$(MLLITE_DIR) -I$(MPL_DIR) -I$(MLSDK_ROOT)/mlutils
CFLAGS += -I$(ML_COMMON_DIR) -I$(MLSDK_ROOT)/mltools/debugsupport -I..
